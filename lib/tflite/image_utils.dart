...
class ImageUtils {
  ...
  static image_lib.Image convertBGRA8888ToImage(CameraImage cameraImage) {
    image_lib.Image img = image_lib.Image.fromBytes(cameraImage.planes[0].width ?? 300,
  ...
  static Future<String> saveImage(image_lib.Image image, String objText, [int i = 0]) async {
